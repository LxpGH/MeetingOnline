...
public class SWVideoEncoder {
	...
	private com.alex.livertmppushsdk.OpenH264Encoder _OpenH264Encoder = null;
    ...
    public boolean start(int iFormateType){
    	int iType = com.alex.livertmppushsdk.OpenH264Encoder.YUV420_TYPE;
    	
    	if(iFormateType == android.graphics.ImageFormat.YV12){
    		iType = com.alex.livertmppushsdk.OpenH264Encoder.YUV12_TYPE;
    	}else{
    		iType = com.alex.livertmppushsdk.OpenH264Encoder.YUV420_TYPE;
    	}
    	_OpenH264Encoder = new com.alex.livertmppushsdk.OpenH264Encoder();
